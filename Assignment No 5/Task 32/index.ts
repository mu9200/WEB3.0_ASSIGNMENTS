...
let current_users: string[] = ["Mudasar", "Ali", "Numan", "Hasan", "Faisal"];


// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.

let new_users: string[] = ["Ateeq", "Waqas", "Numan", "Hasan", "Ahmad"];
...
for (let newUsername of new_users) {
    ...
    let isUsernameTaken = current_users.some((currentUsername) =>
      currentUsername.toLowerCase() === lowerCaseNewUsername
    );
